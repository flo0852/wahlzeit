...
public class CoordinateOld {
    ...
    // Constructor
    public CoordinateOld(double cx, double cy, double cz) {
        x = cx;
        y = cy;
        z = cz;
    }
    ...
    public double getDistance(CoordinateOld c) {
        if (c == null) {
    ...
    public boolean equals(Object o) {
        ...
        if (o.getClass() == getClass()) {
            return isEqual((CoordinateOld) o);
        } else {
            return false;
        }
    }

    public boolean isEqual(CoordinateOld c) {
