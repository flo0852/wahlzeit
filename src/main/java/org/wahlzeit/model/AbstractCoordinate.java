...
public abstract class AbstractCoordinate implements Coordinate {
    ...
    public double getCentralAngle(Coordinate c){
        ...
        if(c1.getRadius() != c2.getRadius()){ //evtl Toleranz???

        }

        double latitude1 = c1.getPhi() + 90;
        double longitude1 = c1.getTheta();

        double latitude2 = c2.getPhi() + 90;
        double longitude2 = c2.getTheta();
        
        double centralAngle = Math.acos(Math.sin(latitude1)*Math.sin(latitude2)+Math.cos(latitude1)*Math.cos(latitude2)*Math.cos(Math.abs(longitude2-longitude1)));
    ...
    public boolean equals(Object o) {
        ...
        if(o.getClass() == Coordinate.class || o.getClass() == CartesianCoordinate.class || o.getClass() == SphericCoordinate.class){
            isEqual((Coordinate) o);
        }
        return false;
    }
